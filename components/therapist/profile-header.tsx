  ...
  return (
    <div>
      ...
      <div className="mt-6 space-y-5">
        ...
        <div>
          <div className="mono mb-2 text-sm font-semibold uppercase tracking-[0.12em] text-[var(--color-sage)]">My approach</div>
          <p className="text-[var(--color-ink)]/90 leading-relaxed">{therapist.approach}</p>
        </div>

        <div>
          <div className="mono mb-2 text-sm font-semibold uppercase tracking-[0.12em] text-[var(--color-sage)]">Focus areas</div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <div className="mono mb-2 text-sm font-semibold uppercase tracking-[0.12em] text-[var(--color-sage)]">Session modes</div>
            <div className="text-sm text-[var(--color-ink)]/90">
              {therapist.modes.map(m => modeLabels[m]).join(" · ")}
            </div>
          </div>
          <div>
            <div className="mono mb-2 text-sm font-semibold uppercase tracking-[0.12em] text-[var(--color-sage)]">Insurance</div>
            <div className="text-sm text-[var(--color-ink)]/90">
